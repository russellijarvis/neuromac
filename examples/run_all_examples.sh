...
PYTHONPATH=straight_to_pia/:$PYTHONPATH
time python ../Admin.py 1 straight_to_pia/straight.cfg
...
PYTHONPATH=update_environment/:$PYTHONPATH
time python ../Admin.py 1 update_environment/update_env.cfg 
...
PYTHONPATH=to_pia/:$PYTHONPATH
time python ../Admin.py 8 to_pia/many.cfg
python ../scripts/generate_SWC_data.py update_environment/update_env.cfg update_environment/update.db
...
PYTHONPATH=to_pia/:$PYTHONPATH
time python ../Admin.py 8 to_pia/to_pia.cfg
...
PYTHONPATH=demo_attraction/:$PYTHONPATH
time python ../Admin.py 16 demo_attraction/demo_distant_attraction.cfg 
...
PYTHONPATH=self_avoidance/:$PYTHONPATH
time python ../Admin.py 1 self_avoidance/selfavoidance.cfg 
